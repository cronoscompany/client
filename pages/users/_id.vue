  ...
  <div class="container mx-auto mt-16">
    <div class="flex space-x-6 mx-auto">
      <div class="flex flex-col items-end w-1/3">
        ...
        <template v-if="friendRequestSendFrom">
          <div class="flex">
              ...
              <green-button type="submit">
                ...
                <svg
                  ...
                  class="
                    ...
                    text-white
                    svg-inline--fa
                    fa-user-plus fa-w-20
                  "
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 640 512"
                >
                  <path
                    d="M624 208h-64v-64c0-8.8-7.2-16-16-16h-32c-8.8 
                  0-16 7.2-16 16v64h-64c-8.8 0-16 7.2-16 16v32c0 8.8 7.2
                   16 16 16h64v64c0 8.8 7.2 16 16 16h32c8.8 0 16-7.2 
                   16-16v-64h64c8.8 0 16-7.2 16-16v-32c0-8.8-7.2-16-16-16zm-400
                    48c70.7 0 128-57.3 128-128S294.7 0 224 0 96 57.3 96 128s57.3
            ...
            <form @submit.prevent="danyFriend" class="ml-3">
        ...
        <template v-else-if="friendRequestSendTo">
          <span>Pending</span>
        </template>
        <template v-else-if="isFriendsWith">
          <form @submit.prevent="deleteFriend">
            <red-button type="submit">Unfriend</red-button>
          </form>
        </template>
    ...
    getUser() {
      this.$axios
        ...
        .then((resp) => {
          ...
          this.friendRequestSendTo = resp.friendRequestSendTo;
          this.friendRequestSendFrom = resp.friendRequestSendFrom;
        })
        .catch((err) => {
          console.log(err);
        });
